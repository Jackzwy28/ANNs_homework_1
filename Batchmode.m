  ...
  for t = 1:300
     ...
     for k=1:1
         ...
         for j=1:hiddenlayer
            ...
            w_hidden_new(k,j)=deltaW1(k,j)+w_hidden_new(k,j);
         end
     end
     ...
     for j=1:hiddenlayer
         for i=1:3
             ...
             w_in_new(j,i)=deltaW2(j,i)+w_in_new(j,i);
         end
     end
  end
     w_hidden_new=w_hidden_new/300;
     w_in_new=w_in_new/300;
     w_hidden=w_hidden+w_hidden_new;
     w_in= w_in+w_in_new ;    
